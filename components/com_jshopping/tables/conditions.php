...
class jshopConditions extends JTableAvto 
{

    public function __construct(&$_db)
    {
        parent::__construct('#__jshopping_shipping_conditions', 'condition_id', $_db);
    }
    ...
    {        
        return JSFactory::getModel('conditionsadmin')->getAllConditions();
    }    
