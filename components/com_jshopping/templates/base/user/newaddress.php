...
$flashDataOfNewAddressSave = $this->flashDataOfNewAddressSave;
?>

<div id="qc_error" class="display--none"></div>

<div class="shop addNewUserAddress">
	<h1 class="addNewUserAddress__page-title">
		<?php echo JText::_('COM_SMARTSHOP_ADD_NEW_ADDRESS'); ?>
	</h1>

	<form action="<?php echo $this->action; ?>" id="addNewUserAddressForm" method="post" name="loginForm" onsubmit="return shopUser.validateAddress(this.name)" class="form-horizontal" enctype="multipart/form-data">
        ...
        <?php if(!empty($config_fields)): ?>
                ...
                <?php } elseif($k == 'birthday'){ ?>
                    <div class="form-group row">
                        <label for="birthday" class="col-sm-5 col-md-4 col-lg-3 col-form-label">
                            ...
                            <?php if ($config_fields['birthday']['require']) : ?>
                                <span>*</span>
                            <?php endif; ?>
                        </label>

                        <div class="col-sm-7 col-md-8 col-lg-9">
                            <?php echo JHTML::_('calendar', $flashDataOfNewAddressSave['birthday'] ?? null, 'birthday', 'birthday', $this->config->field_birthday_format, ['class' => 'input', 'size' => '25', 'maxlength' => '19']);?>
                ...
                <?php }elseif($k == 'country'){ ?>
                    <div class="form-group row">
                        <label for="country" class="col-sm-5 col-md-4 col-lg-3 col-form-label">
                            ...
                            <?php if ($config_fields['country']['require']) : ?>
                                <span>*</span>
                            <?php endif; ?>
                        </label>
			...
			<?php }else{ ?>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7 col-md-8 col-lg-9">
                            <input name="<?php echo $k; ?>" type="text" id="<?php echo $k; ?>" placeholder="<?php echo JText::_('COM_SMARTSHOP_'.strtoupper($k)); ?>" value="<?php echo $flashDataOfNewAddressSave[$k] ?? ''; ?>" class="input" />
