<?php
    ...
    if (isset($this->uploadBlockNumber)) {
...
<template id="nativeProgressUploadRow">
    ...
    <div class="col-md-12 mb-4" data-native-upload-row-number="#">
            ...
            <div class="nativeProgressUpload-imageInfo display--none">
                <div class="row">
                    ...
                    <div class="col-md-8 align-self-center">
                        ...
                        <input type="number" class="nativeProgressUpload-imageInfo__qtyInput" name="nativeProgressUpload[uploads][<?php print $uploadBlockNumber; ?>][qty][]" min="0" value="1" onchange="uploadImage.updateQuantity(1, this);shopProductFreeAttributes.setData();">
                        </div>
                ...
                <?php if ($uploadCommonSettings->upload_design == 1) : ?>
                    <input type="text" name="nativeProgressUpload[uploads][<?php print $uploadBlockNumber; ?>][descriptions][]" class="nativeProgressUpload-imageInfo__describeInput" placeholder="<?php echo JText::_('COM_SMARTSHOP_UPLOAD_DESCRIPTION'); ?>">
                <?php endif; ?>

                <input type="hidden" name="nativeProgressUpload[uploads][<?php print $uploadBlockNumber; ?>][previews][]" class="nativeProgressUpload__imageInput">
                <input type="hidden" name="nativeProgressUpload[uploads][<?php print $uploadBlockNumber; ?>][files][]" class="nativeProgressUpload__fileInput">
