...
if(!class_exists('TCPDF_FONT_DATA')) {
    if(file_exists(JPATH_BASE.'/components/com_expresseditor/tcpdf/include/tcpdf_font_data.php')){
        require_once( JPATH_BASE.'/components/com_expresseditor/tcpdf/include/tcpdf_font_data.php');
    }else{
...
if(!class_exists('TCPDF_FONTS')) {
    if(file_exists(JPATH_BASE.'/components/com_expresseditor/tcpdf/include/tcpdf_fonts.php')){
        require_once( JPATH_BASE.'/components/com_expresseditor/tcpdf/include/tcpdf_fonts.php');
    }else {
...
if(!class_exists('TCPDF_COLORS')) {
    if(file_exists(JPATH_BASE.'/components/com_expresseditor/tcpdf/include/tcpdf_colors.php')){
        require_once( JPATH_BASE.'/components/com_expresseditor/tcpdf/include/tcpdf_colors.php');
    }else {
...
if(!class_exists('TCPDF_IMAGES')) {
    if(file_exists(JPATH_BASE.'/components/com_expresseditor/tcpdf/include/tcpdf_images.php')){
        require_once( JPATH_BASE.'/components/com_expresseditor/tcpdf/include/tcpdf_images.php');
    }else {
...
if(!class_exists('TCPDF_STATIC')) {
    if(file_exists(JPATH_BASE.'/components/com_expresseditor/tcpdf/include/tcpdf_static.php')){
        require_once( JPATH_BASE.'/components/com_expresseditor/tcpdf/include/tcpdf_static.php');
    }else {
...
class TCPDF {
	...
	public function AddFont($family, $style='', $fontfile='', $subset='default') {
		...
		if (TCPDF_STATIC::empty_string($fontfile) OR (!@TCPDF_STATIC::file_exists($fontfile))) {
            ...
            $fontdir = ($fontdir && $fontdir != '') ? $fontdir : JPATH_ROOT.'/components/com_jshopping/lib/tcpdf/fonts/';
