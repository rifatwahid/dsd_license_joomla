...
<thead>
  <tr>
    ...
    <th scope="col" width="150" class="center">
        <?php echo JText::_('COM_SMARTSHOP_AUTOMATIC_EXECUTION'); ?>
    </th>
...
<tr class="row<?php echo $i % 2;?>">
    ...
    <td class="center">
        <a class="btn btn-micro" href='index.php?option=com_jshopping&controller=importexport&task=remove&cid=<?php print $row->id?>' onclick="return confirm('<?php print JText::_('COM_SMARTSHOP_DELETE')?>');">
