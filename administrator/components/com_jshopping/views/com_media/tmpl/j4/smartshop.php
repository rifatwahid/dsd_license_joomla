...
$this->providers = array_filter($this->providers, function ($provider) {
	return $provider->name == 'smartshoplocal';
});
...
$config = array(
	'apiBaseUrl'          => Uri::base() . 'index.php?option=com_media&author=' . $input->get('author') . '&format=json' . $mediaTypes,
	'csrfToken'           => Session::getFormToken(),
	'filePath'            => $shopConfig->path_to_files,
	'fileBaseUrl'         => Uri::root() . $shopConfig->path_to_files,
	'fileBaseRelativeUrl' => Uri::root() . $shopConfig->path_to_files,
...
?>
<div id="com-media" class="smartshop-file-manager"></div>
