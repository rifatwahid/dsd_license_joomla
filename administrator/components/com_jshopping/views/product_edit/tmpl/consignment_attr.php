...
?>
<div id="price_per_consignment_attr" class="tab-pane">
    <div class="col100">
     ...
     <tr>
       ...
       <td>
         <input type="text" name="product_price" id="product_price" value="<?php echo $row->product_price?>" <?php if (!$this->withouttax){?> onkeyup="shopProductPrice.update(<?php print $jshopConfig->display_price_admin;?>, true)" <?php }?> /> <?php echo $this->lists['currency'];?>
       </td>
     </tr>
     <tr>
       <td class="key">
            ...
            <thead>
                ...
                foreach($add_prices as $key => $addPrices) :
                    ...
                    <tr id="add_price_<?php echo $iterationNumber; ?>">
                        <td>
                           <input type="text" class="small3" name="quantity_start[]" id="quantity_start_<?php print $iterationNumber; ?>" value="<?php echo $addPrice->product_quantity_start;?>" />    
                        </td>
                        <td>
                           <input type="text" class="small3" name="quantity_finish[]" id="quantity_finish_<?php print $iterationNumber; ?>" value="<?php echo $addPrice->product_quantity_finish;?>" />    
                        </td>
                        <td>
                           <input type="text" class="small3" name="product_add_discount[]" id="product_add_discount_<?php print $iterationNumber; ?>" value="<?php echo $addPrice->discount;?>" onkeyup="productAddPriceupdateValue(<?php echo $iterationNumber; ?>)" />    
                        </td>
                        <td>
                            <input type="text" class="small3" name="product_add_price[]" id="product_add_price_<?php print $iterationNumber; ?>" value="<?php echo $_add_price;?>" />
                ...
                <?php $iterationNumber++; endforeach; endforeach; ?>  
                </tbody>              
            </table>
