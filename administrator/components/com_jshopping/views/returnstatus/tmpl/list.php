...
$i=0;
?>
<form action="index.php?option=com_jshopping&controller=returnstatus" method="post" name="adminForm" id="adminForm">
...
<thead>
  <tr>
    ...
    <th scope="col" width="600" align="left">
...
<?php foreach($rows as $row){ ?>
  <tr class="row<?php echo $i % 2;?>">
   ...
   <td>
     <a title="<?php echo JText::_('COM_SMARTSHOP_EDIT_RETURN_STATUS');?>" href="index.php?option=com_jshopping&controller=returnstatus&task=edit&status_id=<?php echo $row->status_id; ?>"><?php echo $row->name;?></a>
   </td>
	<td class="center">
   	    <a class="btn btn-micro" href='index.php?option=com_jshopping&controller=returnstatus&task=edit&status_id=<?php echo $row->status_id; ?>'>
            <i class="icon-edit"></i>
        </a>
   	</td>
    <td class="center">
