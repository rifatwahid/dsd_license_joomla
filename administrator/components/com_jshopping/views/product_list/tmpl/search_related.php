...
<div class="block_related" id="serched_product_<?php print $row->product_id;?>">
    <div class="block_related_inner">
        ...
        <div class="image">
            ...
            <?php } else { ?>
                <img src="<?php print getPatchProductImage($this->config->path_to_no_img, '', 1)?>" width="90" border="0" />
            <?php } ?>
            </a>
        </div>
        <div style="padding-top:5px;"><input type="button" class="btn btn-small btn-success" value="<?php print JText::_('COM_SMARTSHOP_ADD');?>" onclick="shopProductRelated.add(<?php print $row->product_id;?>)"></div>
    </div>
</div>
<?php
}
...
<table align="center">
<tr>
    <td><?php print JText::_('COM_SMARTSHOP_PAGE')?>: </td>
    <td>
    <div class="pagination">
        ...
        <div class="page">
            ...
            <?php for($i=$pstart;$i<=$pfinish; $i++){?>
                <a onclick="shopProductRelated.search(<?php print ($i-1)*$this->limit;?>, <?php print $this->no_id?>);return false;" href="#"><?php print $i;?></a>
            <?php } ?>
