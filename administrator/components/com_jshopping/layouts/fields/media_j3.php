...
$url    = ($readonly ? ''
	: ($link ?: 'index.php?option=com_media&amp;view=' . $view . '&amp;tmpl=component&amp;asset='
		. $asset . '&amp;author=' . $authorId)
	. '&amp;fieldid={field-media-id}&amp;ismoo=0&amp;folder=' . $folder);
?>
<div class="field-media-wrapper field-media-wrapper-smartshop"
...
>
	...
	<div class="input-prepend input-append">
		<span rel="popover" class="add-on pop-helper field-media-preview"
			title="<?php echo JText::_('JLIB_FORM_MEDIA_PREVIEW_SELECTED_IMAGE'); ?>" data-content="<?php echo $src; ?>"
	...
	<div class="input-append">
		...
		<?php if ($disabled != true) : ?>
			<button type="button" class="btn btn-primary button-select"><?php echo JText::_('JLIB_FORM_BUTTON_SELECT'); ?></button>
			<button
				type="button"
				class="btn btn-primary hasTooltip button-clear"
